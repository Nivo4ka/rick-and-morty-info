module.exports = {
  ...
  plugins: ['react', 'styled-components-config', 'eslint-plugin-no-inline-styles', '@typescript-eslint', '@emotion'],
  globals: {
    Atomics: 'readonly',
  ...
  rules: {
    ...
    'no-param-reassign': ['error', { props: true, ignorePropertyModificationsFor: ['store', 'acc', 'item'] }],
    semi: 'off',
